...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/business/controller/AdviceController/editPlant.do',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" >
		...
		<input name="advice_plant_id" type="hidden" value="${ advice.advice_plant_id }"/>
			<table class="table table-hover table-condensed">
				...
				<th>生育时期</th>
					...
					<tr>
					<th>病虫害发生条件 </th>
					<td colspan="3"><textarea name="conditions" rows="10" cols="" class="span5">${advice.conditions}</textarea></td>
					</tr>
					<tr>
					<th>病虫害发生症状 </th>
					<td colspan="3"><textarea name="symptom" rows="10" cols="" class="span5">${advice.symptom}</textarea></td>
					</tr>
					<tr>
					<th>病虫害防治措施 </th>
					<td colspan="3"><textarea name="measures" rows="10" cols="" class="span5">${advice.measures}</textarea></td>
				</tr> 
			</table>
		</form>
	</div>
