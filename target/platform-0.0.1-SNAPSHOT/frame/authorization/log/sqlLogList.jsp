...
TreeMap sqlLogMap = (TreeMap)map.get("sqlLogMap");
%>
<head>
<title>登录日志管理</title>
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			url : '${pageContext.request.contextPath}/authorization/controller/SysLogController/doSqlLogQuery.do',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,
...
<body>
	<c:forEach items="<%=sqlLogMap%>" var="sqlLogMap">
		<input type="hidden" id="${ sqlLogMap.key}" value="${ sqlLogMap.value}" />
	</c:forEach>
<div id="win"></div>
