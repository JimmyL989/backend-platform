...
public class Lunar {
    ...
    public static void main(String[] args) {
        ...
        t.clear();
        t.set(2014, 8-1, 8);
//        System.out.println(t.getTime().getMonth() + "月");
...
//
//        System.out.println("=================================================================");
//        Date[] jieqi1 = jieqilist(2014);
//        for (int i = 0; i < solarTerm.length; i++) {
//            System.out.print(solarTerm[i]);
//            System.out.print(jieqi1[i].getMonth() + "月");
//            System.out.println(jieqi1[i].getDate());
//            System.out.println(sdf.format(jieqi1[i]));
//        }
//        System.out.println("=================================================================");
//        Date[] jieqi2 = abc(2014);
//        for (int i = 0; i < solarTerm.length; i++) {
//        	System.out.print(solarTerm[i]);
//        	System.out.print(jieqi2[i].getMonth() + "月");
//        	System.out.println(jieqi2[i].getDate());
//        	System.out.println(sdf.format(jieqi2[i]));
//        }
//        System.out.println("=================================================================");
        
        
        
        List<Date> jieqi =Alljieqi1(2014);
        ...
        try {
			System.out.println(new Lunar(sdf.parse("2013-07-22 02:51:35").getTime()).getTermString());
    ...
    public static Date[] abc(int year) {
    	...
    	for (int i = 0; i < 12; i++) {
    		t.clear();
    			...
    			termString = Lunar.solarTerm[i * 2];
    			day = Lunar.getSolarTermDay(year, i * 2);
    			String s = year + "-" + jj + "-" + Lunar.getSolarTermDay(year, i * 2);
    			t.set(year, i, Lunar.getSolarTermDay(year, i * 2));
//    			try {
					returnvalue[i*2] = t.getTime();
//					returnvalue[i] = sdf1.parse(s);
//				} catch (ParseException e) {
//					// TODO Auto-generated catch block
//					e.printStackTrace();
//				}
    			
    			termString = Lunar.solarTerm[(i) * 2 + 1];
    			s = year + "-" + jj + "-" + termString;
    			t.clear();
    			t.set(year, i, Lunar.getSolarTermDay(year, (i) * 2 + 1));
    			returnvalue[i*2+1] = t.getTime();
//    			try {
//					returnvalue[i] = sdf1.parse(s);
//				} catch (ParseException e) {
//					// TODO Auto-generated catch block
...
//				}
    ...
    public static long getaftersolarTerm(int year, Date date) {
		...
		for (int i = 0; i < jieqi.size(); i++) {
	            ...
	            System.out.println(sdf.format(jieqi.get(i)) + "------------" + i);
		}
       System.out.println("--------------------------------------------");
        int[] jieqibeforeafter = getnearsolarTerm(year, date);
        System.out.println("-----------------------" + jieqibeforeafter[1]);
        System.out.println("-----------------------" + sdf.format(jieqi.get(jieqibeforeafter[1])));
    ...
    public static List<Date> Alljieqi1(int year)
    {
    ...
    public static int[] getnearsolarTerm(int year, Date date) {
      List<Date> jieqi =Alljieqi1(year);
