...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/business/controller/AdviceController/addCultivation.do',
			onSubmit : function() {
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			...
			<tr>
				...
				<th>生育时期</th>
					<td colspan=""><input id="period_id" name="period_id" class="easyui-combobox" data-options="width:320, valueField: 'period_id',textField: 'period_name'" />   </td>	
								</tr>
								<tr>
					<th>栽培技术 </th>
