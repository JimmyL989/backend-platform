...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/business/controller/AdviceController/editFaming.do',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<input name="advice_farming_id" type="hidden" value="${ advice.advice_farming_id }"/>
			<table class="table table-hover table-condensed">
				...
				<th>生育时期</th>
					<td colspan=""><input id="period_id" name="period_id" class="easyui-combobox" data-options="required:true,width:320, valueField: 'period_id',textField: 'period_name', onLoadSuccess : function(){
