...
TreeMap logonLogMap = (TreeMap)map.get("logonLogMap");
%>
<head>
<title>登录日志管理</title>
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			url : '${pageContext.request.contextPath}/authorization/controller/SysLogController/doLogonLogQuery.do',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,
...
<body>
	<c:forEach items="<%=logonLogMap%>" var="logonLogMap">
		<input type="hidden" id="${ logonLogMap.key}" value="${ logonLogMap.value}" />
	</c:forEach>
<div id="win"></div>
