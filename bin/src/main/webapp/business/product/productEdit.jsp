	 ...
	 $(function() {
		...
		$('#form').form({
			...
			onSubmit : function() {
				...
				if('${sessionScope.logon_sysuser.userid}' != cuserid && '${sessionScope.logon_sysuser.userid}' != '1'){
	...
	<table class="table table-hover table-condensed" style="height: 60px">
				<tr>
					...
					url: '${pageContext.request.contextPath}/business/controller/DCPController/getDivision.do?id=9999', 
           			...
           			<td width="120px" style="padding-top: 12px"><input id="state" name="state" type="text" class="span2" readonly="readonly" value=""></input></td>
				</tr>
			</table>
	</div>
		 	...
		 	<div data-options="region:'west',border:false" title="" style="overflow: hidden;width: 380px">
		 		<table class="table table-hover table-condensed">
					...
					<tr>
						...
						<td>
							<textarea name="messageBody" placeholder="请编辑短信内容..."  id="messageBody" rows="13" cols="" style="width: 320px;resize: none;font-size:16px; color:#000; " onPropertyChange="validMaxSize()" oninput="validMaxSize()" class="easyui-validatebox" data-options="required:true,validType:'maxCharLength[280]'"></textarea>
						</td>
						</tr>
						<tr>
