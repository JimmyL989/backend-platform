...
<script type="text/javascript">
	 ...
	 $(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/business/controller/DivisionController/editDivision.do',
			onSubmit : function() {
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		 ...
		 <input name="parentid" type="hidden" value="${resource.parentid }"/>
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th>区划ID</th>
					<td><input name="admin_region_id" type="text" class="easyui-validatebox span2" value="${resource.admin_region_id}" data-options="required:true" readonly="readonly"></td>
					<th>区划名称</th>
