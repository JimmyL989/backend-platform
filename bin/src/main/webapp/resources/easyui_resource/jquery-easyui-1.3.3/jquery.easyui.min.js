...
if(_6f.iconCls.lastIndexOf("icon-") != -1)
	t.find(".l-btn-text").addClass("l-btn-icon-left-spantext");
}
}else{
...
function _4a9(_4aa,_4ab,_4ac){
	if($.data(_4aa,"datagrid") == undefined) 
		return;
...
function _50e(_50f){
	if($.data(_50f,"datagrid") == undefined)
		return;
...
return jq.each(function(){
	if($(this).datagrid("getPager") == undefined)
		return;
